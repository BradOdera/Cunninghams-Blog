...
def blog(id):
    ...
    if comment_form.validate_on_submit():
        ...
        new_comment = Comments(
            comment=comment, user_id=current_user, blog_id=blog)
...
def subscribe():
    ...
    mail_message("Subscribed to Blog Post.", "email/welcome_subscriber",
                 new_subscriber.email, new_subscriber=new_subscriber)
